            ...
            <div className="bg-gray-500 p-6 rounded-lg">
                ...
                <div className="text-balance">
                    {loading ? (
                        ...
                        <>
                            <p><span className="font-bold">Name:</span> {pairData!.baseToken.name}</p>
                            <p><span className="font-bold">Symbol:</span> {pairData!.baseToken.symbol}</p>
                ...
                <div className="text-balance">
                    {loading ? (
                        ...
                        <>
                            ...
                            <p>Average Price (SOL): {averagePriceSol.toFixed(10)}</p>
                            <p>Average Price (USD): ${averagePriceUsd.toFixed(6)}</p>
                            <p>Combined 24h Volume: {combinedVolume24h.toFixed(2)}</p>
                            <p>Combined Price Change (24h): {combinedPriceChange24h.toFixed(2)}%</p>
                        </>
                    )}
                </div>
            </div>
